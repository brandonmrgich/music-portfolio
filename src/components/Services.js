        ...
        <div className="services p-6 max-w-4xl mx-auto space-y-12">
            ...
            <section className="mixing-mastering space-y-4">
                ...
                <p className="text-lg text-gray-700">
                    ...
                    color and full tone. I love songs that surround the listener
                    and take advantage of the stereo field, so I do my best to
                    achieve this.
                </p>
                <p className="text-lg text-gray-700">
                ...
                <p className="text-lg text-gray-600 italic">
                    Requests are currently FREE, as I am adding to a 'sample
