        ...
        >
            <div className="flex items-center space-x-2">
                {isAdmin ? (
                    <>
                        <a
                            href="https://linktr.ee/brandonamrgich"
                            target="_blank"
                        ...
                        >
                            <img
                                src="/asailboat.png"
                                alt="Logo"
                                className="h-9 w-9 rounded-full hover:scale-105 transition-transform duration-200"
                                width="36"
                                height="36"
                                decoding="async"
                            />
                        ...
                        <button
                            onClick={logout}
                            className="ml-4 px-3 py-1 rounded bg-accent-dark text-white text-sm"
                        >
                            Logout
                        </button>
                    </>
