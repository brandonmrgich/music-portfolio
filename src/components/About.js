...
const About = ({ isAdmin }) => {
  ...
  return (
    <div className="about p-6 max-w-4xl mx-auto space-y-12">
      <h1 className="text-4xl font-bold text-center mb-6">Brandon Mrgich</h1>
      ...
      <section className="text-center mb-8">
        <p className="text-lg text-gray-700 mb-4">
          Brandon is a multi-instrumentalist based out of Florida, with a
          lifelong passion for music. From a young age, his fascination with
          sound has driven him to explore and create. On March 1st 2024, along
          with
          <a
            className="text-blue-500 hover:text-blue-900 font-light"
          ...
          This album consists of four live performances in an eerily empty
          auditorium. Equipped with Brandon's H1N field recording mic, piano,
          Blueshades synth, looper, and vocals, they managed to create an
          atmosphere filled with an undeniable "in-the-moment" feeling.
        </p>
      </section>
    </div>
  );
